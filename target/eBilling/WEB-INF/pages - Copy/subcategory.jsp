...
<div class="main_content">
    <div class="block">
        <h2><span class="icon1">&nbsp;</span>Add New Sub Category</h2>
    ...
    <div class="block table-toop-space">
        <div class="head-box"><h2><span class="icon2">&nbsp;</span>Current Sub Categories </h2><aside class="search-box">        
        ...
        <div class="block-box-big block-box-last-big">
            <ul class="table-list">
                <li class="dept-box">Sub Category Name
                    <ul>
            ...
            <div class="table-list-blk data-grid-big">
                <ul>
                    <li class="dept-box">Sub Category1</li>
                    <li class="ten-box"><a href="#">Delete</a></li>
                    <li class="eleven-box last"><a href="#">Edit</a></li>
                </ul>
                <ul>
                    <li class="dept-box">Sub Category2</li>
                    <li class="ten-box"><a href="#">Delete</a></li>
                    <li class="eleven-box last"><a href="#">Edit</a></li>
                </ul>
                <ul>
                    <li class="dept-box">Sub Category3</li>
                    <li class="ten-box"><a href="#">Delete</a></li>
                    <li class="eleven-box last"><a href="#">Edit</a></li>
                </ul>
                <ul>
                    <li class="dept-box">Sub Category4</li>
                    <li class="ten-box"><a href="#">Delete</a></li>
                    <li class="eleven-box last"><a href="#">Edit</a></li>
                </ul>  
                <ul>
                    <li class="dept-box">Sub Category5</li>
                    <li class="ten-box"><a href="#">Delete</a></li>
                    <li class="eleven-box last"><a href="#">Edit</a></li>
                </ul>
                <ul>
                    <li class="dept-box">Sub Category6</li>
                    <li class="ten-box"><a href="#">Delete</a></li>
                    <li class="eleven-box last"><a href="#">Edit</a></li>
                </ul>
                <ul>
                    <li class="dept-box">Sub Category7</li>
                    <li class="ten-box"><a href="#">Delete</a></li>
                    <li class="eleven-box last"><a href="#">Edit</a></li>
                </ul>
                <ul>
                    <li class="dept-box">Sub Category8</li>
                    <li class="ten-box"><a href="#">Delete</a></li>
                    <li class="eleven-box last"><a href="#">Edit</a></li>
                </ul>
                <ul>
                    <li class="dept-box">Sub Category9</li>
                    <li class="ten-box"><a href="#">Delete</a></li>
                    <li class="eleven-box last"><a href="#">Edit</a></li>
                </ul>
                <ul>
                    <li class="dept-box">Sub Category10</li>
                    <li class="ten-box"><a href="#">Delete</a></li>
                    <li class="eleven-box last"><a href="#">Edit</a></li>
                </ul>                 
            </div>
