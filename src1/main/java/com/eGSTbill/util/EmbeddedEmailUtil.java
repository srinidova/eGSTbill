 ...
 *
 */
public class EmbeddedEmailUtil {
	 ...
	 */
	static Logger logger = Logger.getLogger(EmbeddedEmailUtil.class);
	public static void send(String host, String port,
			final String userName, final String password, String toAddress,String ccAddress, String bccAddress,
			String subject, String htmlBody, 
			Map<String, String> mapInlineImages)
				throws AddressException, MessagingException {
		logger.error("E:-EmbeddedImageEmailUtil send() Start Start");
		try{
